...
import org.apache.amoro.scheduler.RestCatalogService;
import org.apache.amoro.scheduler.table.InternalIcebergCreator;
import org.apache.amoro.scheduler.table.InternalIcebergHandler;
...
public class InternalIcebergCatalogImpl extends InternalCatalog {
  ...
  public AmoroTable<?> loadTable(String database, String tableName) {
    ...
    return IcebergTable.newIcebergTable(
        tableIdentifier,
        table,
        UnifiedCatalogUtil.buildMetaStore(getMetadata()),
