...
package org.apache.amoro.scheduler.table;
...
import org.apache.amoro.scheduler.DefaultSchedulerConstants;
import org.apache.amoro.scheduler.OptimizingConfig;
...
import org.apache.amoro.scheduler.optimizing.OptimizingType;
import org.apache.amoro.scheduler.optimizing.TaskRuntime;
...
import org.apache.amoro.scheduler.utils.IcebergTableUtil;
...
public class DefaultTableRuntime extends StatedPersistentBase {
  ...
  @StateField
  private volatile long currentSnapshotId = DefaultSchedulerConstants.INVALID_SNAPSHOT_ID;

  @StateField
  private volatile long lastOptimizedSnapshotId = DefaultSchedulerConstants.INVALID_SNAPSHOT_ID;

  @StateField
  private volatile long lastOptimizedChangeSnapshotId =
      DefaultSchedulerConstants.INVALID_SNAPSHOT_ID;
  // for change table
  @StateField
  private volatile long currentChangeSnapshotId = DefaultSchedulerConstants.INVALID_SNAPSHOT_ID;
  ...
  protected DefaultTableRuntime(
      TableRuntimeMeta tableRuntimeMeta, TableRuntimeHandler tableHandler) {
  ...
  public void addTaskQuota(TaskRuntime.TaskQuota taskQuota) {
    ...
    long validTime = System.currentTimeMillis() - DefaultSchedulerConstants.QUOTA_LOOK_BACK_TIME;
    this.taskQuotas.removeIf(task -> task.checkExpired(validTime));
  }

  private void persistTableRuntime() {
    doAs(TableRuntimeMapper.class, mapper -> mapper.insertTableRuntime(this));
  }

  private void persistUpdatingRuntime() {
    doAs(TableRuntimeMapper.class, mapper -> mapper.updateTableRuntime(this));
  }
  ...
  public long getQuotaTime() {
    ...
    long calculatingStartTime = calculatingEndTime - DefaultSchedulerConstants.QUOTA_LOOK_BACK_TIME;
  ...
  public double calculateQuotaOccupy() {
    return new BigDecimal(
            (double) getQuotaTime()
                / DefaultSchedulerConstants.QUOTA_LOOK_BACK_TIME
