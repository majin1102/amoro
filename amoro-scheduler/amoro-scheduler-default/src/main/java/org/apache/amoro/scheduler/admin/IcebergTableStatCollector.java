...
import org.apache.amoro.admin.model.SnapshotInfo;
...
public class IcebergTableStatCollector {
  private static final Logger LOG = LoggerFactory.getLogger(IcebergTableStatCollector.class);
