...
public class RestCatalogService extends PersistentBase {
  ...
  public RestCatalogService(DefaultTableService tableService) {
    ...
    handleNamespace(
        ...
        (catalog, database) -> {
          ...
          try (InternalTableCreator creator =
            ...
            try {
              org.apache.amoro.scheduler.table.TableMetadata metadata = creator.create();
  ...
  public void deleteTable(Context ctx) {
    handleTable(
        ...
        handler -> {
          ...
          org.apache.amoro.scheduler.table.TableMetadata tableMetadata = handler.tableMetadata();
  ...
  private InternalCatalog getCatalog(String catalog) {
    ...
    Set<TableFormat> tableFormats = UnifiedCatalogUtil.tableFormats(internalCatalog.getMetadata());
    Preconditions.checkArgument(
        tableFormats.size() == 1
