...
package org.apache.amoro.scheduler.optimizing.scan;
...
public class KeyedTableFileScanHelper implements TableFileScanHelper {
  ...
  public CloseableIterable<FileScanResult> scan() {
    ...
    if (changeSnapshotId != DefaultSchedulerConstants.INVALID_SNAPSHOT_ID) {
      StructLikeMap<Long> optimizedSequence =
          baseSnapshotId == DefaultSchedulerConstants.INVALID_SNAPSHOT_ID
    ...
    if (baseSnapshotId != DefaultSchedulerConstants.INVALID_SNAPSHOT_ID) {
      baseScanResult =
