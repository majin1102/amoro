...
import org.apache.amoro.scheduler.utils.InternalTableUtil;
...
public class IcebergInternalTableOperations extends PersistentBase implements TableOperations {
  ...
  private org.apache.amoro.scheduler.table.TableMetadata tableMetadata;

  public IcebergInternalTableOperations(
      ServerTableIdentifier identifier,
      org.apache.amoro.scheduler.table.TableMetadata tableMetadata,
      FileIO io) {
    this.io = io;
  ...
  protected String tableMetadataLocation(org.apache.amoro.scheduler.table.TableMetadata tableMeta) {
  ...
  public void commit(TableMetadata base, TableMetadata metadata) {
    ...
    try {
      ...
      org.apache.amoro.scheduler.table.TableMetadata updatedMetadata = doCommit();
  ...
  private org.apache.amoro.scheduler.table.TableMetadata doCommit() {
    ServerTableIdentifier tableIdentifier = tableMetadata.getTableIdentifier();
    AtomicInteger effectRows = new AtomicInteger();
    AtomicReference<org.apache.amoro.scheduler.table.TableMetadata> metadataRef =
        new AtomicReference<>();
    doAsTransaction(
        () -> {
          int effects =
        ...
        () -> {
          org.apache.amoro.scheduler.table.TableMetadata m =
              getAs(
                  InternalTableMapper.class,
  ...
  private void commitTableInternal(
      org.apache.amoro.scheduler.table.TableMetadata amsTableMetadata,
      TableMetadata base,
  ...
  private void checkCommitSuccess(
      org.apache.amoro.scheduler.table.TableMetadata updatedTableMetadata,
