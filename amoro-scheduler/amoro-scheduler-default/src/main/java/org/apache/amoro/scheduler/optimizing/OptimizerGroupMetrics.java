...
import static org.apache.amoro.scheduler.optimizing.TaskRuntime.Status.ACKED;
import static org.apache.amoro.scheduler.optimizing.TaskRuntime.Status.PLANNED;
import static org.apache.amoro.scheduler.optimizing.TaskRuntime.Status.SCHEDULED;
...
public class OptimizerGroupMetrics {
  ...
  public static final MetricDefine OPTIMIZER_GROUP_PENDING_TASKS =
      MetricDefine.defineGauge("optimizer_group_pending_tasks")
  ...
  public static final MetricDefine OPTIMIZER_GROUP_EXECUTING_TASKS =
      MetricDefine.defineGauge("optimizer_group_executing_tasks")
  ...
  public static final MetricDefine OPTIMIZER_GROUP_PLANING_TABLES =
      MetricDefine.defineGauge("optimizer_group_planing_tables")
  ...
  public static final MetricDefine OPTIMIZER_GROUP_PENDING_TABLES =
      MetricDefine.defineGauge("optimizer_group_pending_tables")
  ...
  public static final MetricDefine OPTIMIZER_GROUP_EXECUTING_TABLES =
      MetricDefine.defineGauge("optimizer_group_executing_tables")
  ...
  public static final MetricDefine OPTIMIZER_GROUP_OPTIMIZER_INSTANCES =
      MetricDefine.defineGauge("optimizer_group_optimizer_instances")
        ...
        (Gauge<Long>)
            () ->
                optimizingQueue.getSchedulingPolicy().getTableRuntimeMap().values().stream()
                    .filter(t -> t.getOptimizingStatus().equals(OptimizingStatus.PLANNING))
                    .count());
    registerMetric(
        registry,
        ...
        (Gauge<Long>)
            () ->
                optimizingQueue.getSchedulingPolicy().getTableRuntimeMap().values().stream()
                    .filter(t -> t.getOptimizingStatus().equals(OptimizingStatus.PENDING))
                    .count());
    registerMetric(
        registry,
