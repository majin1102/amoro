...
public class KeyedTableCommit extends UnKeyedTableCommit {
  ...
  public KeyedTableCommit(
    ...
    this.tasks = tasks;
    this.fromSnapshotId =
        fromSnapshotId == null ? DefaultSchedulerConstants.INVALID_SNAPSHOT_ID : fromSnapshotId;
  ...
  private void executeCommit(
    ...
    if (TableTypeUtil.isHive(table) && !needMoveFile2Hive()) {
      overwriteBaseFiles.set(UpdateHiveFiles.DELETE_UNTRACKED_HIVE_FILE, "true");
      overwriteBaseFiles.set(UpdateHiveFiles.SYNC_DATA_TO_HIVE, "true");
    }
