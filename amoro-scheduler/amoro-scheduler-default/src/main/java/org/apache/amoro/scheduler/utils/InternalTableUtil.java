...
package org.apache.amoro.scheduler.utils;

import static org.apache.amoro.scheduler.table.InternalTableConstants.HADOOP_FILE_IO_IMPL;
import static org.apache.amoro.scheduler.table.InternalTableConstants.METADATA_FOLDER_NAME;
import static org.apache.amoro.scheduler.table.InternalTableConstants.MIXED_ICEBERG_BASED_REST;
import static org.apache.amoro.scheduler.table.InternalTableConstants.S3_FILE_IO_IMPL;
import static org.apache.amoro.scheduler.table.InternalTableConstants.S3_PROTOCOL_PREFIX;
...
public class InternalTableUtil {
  ...
  public static boolean isLegacyMixedIceberg(
      org.apache.amoro.scheduler.table.TableMetadata internalTableMetadata) {
  ...
  public static boolean isKeyedMixedTable(
      org.apache.amoro.scheduler.table.TableMetadata serverTableMetadata) {
  ...
  public static AuthenticatedFileIO newIcebergFileIo(CatalogMeta meta) {
    ...
    TableMetaStore store = UnifiedCatalogUtil.buildMetaStore(meta);
