...
import static org.apache.amoro.scheduler.table.InternalTableConstants.CHANGE_STORE_TABLE_NAME_SUFFIX;
...
import org.apache.amoro.formats.mixed.MixedTableImpl;
...
import org.apache.amoro.scheduler.table.InternalMixedIcebergCreator;
import org.apache.amoro.scheduler.table.InternalMixedIcebergHandler;
...
public class InternalMixedCatalogImpl extends InternalIcebergCatalogImpl {
  ...
  public AmoroTable<?> loadTable(String database, String tableName) {
    ...
    TableIdentifier tableIdentifier = TableIdentifier.of(name(), database, tableName);
    ...
    return new MixedTableImpl(mixedIcebergTable, TableFormat.MIXED_ICEBERG);
  }
