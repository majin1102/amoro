...
public class CommonUnifiedCatalog implements UnifiedCatalog {
  ...
  public CommonUnifiedCatalog(
    ...
    UnifiedCatalogUtil.mergeCatalogProperties(catalogMeta, properties);
  ...
  public synchronized void refresh() {
    ...
    UnifiedCatalogUtil.mergeCatalogProperties(meta, properties);
  ...
  protected void initializeFormatCatalogs() {
    ...
    Set<TableFormat> formats = UnifiedCatalogUtil.tableFormats(this.meta);
    Map<TableFormat, FormatCatalog> formatCatalogs = Maps.newConcurrentMap();
    TableMetaStore tableMetaStore = UnifiedCatalogUtil.buildMetaStore(meta);
    for (FormatCatalogFactory factory : loader) {
      if (formats.contains(factory.format())) {
        ...
        FormatCatalog catalog =
            factory.create(name(), meta.getCatalogType(), catalogProperties, tableMetaStore);
