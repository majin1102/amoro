...
import org.apache.amoro.client.AmsClient;
import org.apache.amoro.client.PooledAmsClient;
  ...
  protected class MixedTableBuilder implements TableBuilder {
    ...
    protected void checkProperties() {
      ...
      if (enableStream) {
        ...
        String logStoreType = mergedProperties.get(TableProperties.LOG_STORE_TYPE);
        Preconditions.checkArgument(
            logStoreType == null
            ...
            String.format(
                ...
                TableProperties.LOG_STORE_TYPE,
                logStoreType,
                TableProperties.LOG_STORE_STORAGE_TYPE_KAFKA,
                TableProperties.LOG_STORE_STORAGE_TYPE_PULSAR));
