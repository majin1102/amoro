...
import org.apache.amoro.catalog.AmoroCatalog;
...
public class MixedIcebergHadoopCatalogTestHelper
  ...
  public AmoroCatalog amoroCatalog() {
    ...
    TableMetaStore metaStore = UnifiedCatalogUtil.buildMetaStore(getCatalogMeta());
  ...
  public MixedFormatCatalog originalCatalog() {
    ...
    TableMetaStore metaStore = UnifiedCatalogUtil.buildMetaStore(meta);
