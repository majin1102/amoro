...
public class SimpleSpillableMap<K, T> implements SimpleMap<K, T> {
  ...
  private final KryoSerializationUtil.SimpleSerializer<K> keySerializer;

  private final KryoSerializationUtil.SimpleSerializer<T> valueSerializer;
  ...
  protected SimpleSpillableMap(
    ...
    this(
        ...
        backendBaseDir,
        KryoSerializationUtil.JavaSerializer.INSTANT,
        KryoSerializationUtil.JavaSerializer.INSTANT,
        keySizeEstimator,
        valueSizeEstimator);
  }
  ...
  protected SimpleSpillableMap(
      Long maxInMemorySizeInBytes,
      @Nullable String backendBaseDir,
      KryoSerializationUtil.SimpleSerializer<K> keySerializer,
      KryoSerializationUtil.SimpleSerializer<T> valueSerializer,
      SizeEstimator<K> keySizeEstimator,
      SizeEstimator<T> valueSizeEstimator) {
