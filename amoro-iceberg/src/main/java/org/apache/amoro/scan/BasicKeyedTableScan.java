...
public class BasicKeyedTableScan implements KeyedTableScan {
  ...
  public BasicKeyedTableScan(BasicKeyedTable table) {
    ...
    this.splitSize =
        PropertyUtil.propertyAsLong(
            table.properties(), IcebergTableProps.SPLIT_SIZE, IcebergTableProps.SPLIT_SIZE_DEFAULT);
    this.lookBack =
        PropertyUtil.propertyAsInt(
            table.properties(),
            IcebergTableProps.SPLIT_LOOKBACK,
            IcebergTableProps.SPLIT_LOOKBACK_DEFAULT);
