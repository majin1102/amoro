...
public class CatalogBuilder {
  ...
  public static ServerCatalog buildServerCatalog(
    ...
    Set<TableFormat> tableFormats = UnifiedCatalogUtil.tableFormats(catalogMeta);
    ...
    switch (type) {
      ...
      case CATALOG_TYPE_AMS:
        ServiceLoader<InternalCatalogFactory> loader =
            ServiceLoader.load(InternalCatalogFactory.class);
        for (InternalCatalogFactory internalCatalogFactory : loader) {
          ServerCatalog serverCatalog =
              internalCatalogFactory.createCatalog(catalogMeta, serverConfiguration);
          if (serverCatalog != null) {
            return serverCatalog;
          }
        }
        throw new IllegalStateException(
            "No supported catalog factory found for table format: " + tableFormat);
      default:
