...
import org.apache.amoro.admin.model.OptimizerInstanceInfo;
import org.apache.amoro.admin.model.OptimizerResourceInfo;
import org.apache.amoro.admin.model.TableFilter;
import org.apache.amoro.admin.model.TableOptimizingInfo;
...
public class OptimizerController {
  ...
  public OptimizerController(OptimizerManager optimizerManager, OptimizingAdmin optimizingAdmin) {
    ...
    PageResult<TableOptimizingInfo> amsPageResult =
        PageResult.of(
            optimizingAdmin.getOptimizingProcessInfos(
                optimizerGroup, page, offset, new TableFilter(dbFilterStr, tableFilterStr)),
            page);
