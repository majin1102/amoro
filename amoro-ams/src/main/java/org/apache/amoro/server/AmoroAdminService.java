...
import org.apache.amoro.server.admin.APITokenManager;
import org.apache.amoro.server.admin.PlatformFileManager;
import org.apache.amoro.server.admin.TableFormatAdmins;
import org.apache.amoro.server.admin.controller.CatalogController;
import org.apache.amoro.server.admin.controller.HealthCheckController;
import org.apache.amoro.server.admin.controller.LoginController;
import org.apache.amoro.server.admin.controller.OptimizerController;
import org.apache.amoro.server.admin.controller.PlatformFileInfoController;
import org.apache.amoro.server.admin.controller.SettingController;
import org.apache.amoro.server.admin.controller.TableController;
import org.apache.amoro.server.admin.controller.TerminalController;
import org.apache.amoro.server.admin.controller.VersionController;
import org.apache.amoro.server.admin.response.ErrorResponse;
import org.apache.amoro.server.admin.utils.ParamSignatureCalculator;
...
public class AmoroAdminService {

  public static final Logger LOG = LoggerFactory.getLogger(AmoroAdminService.class);
  ...
  public AmoroAdminService(
      Configurations serviceConfig,
      CatalogService catalogService,
      OptimizerManager optimizerManager,
      TerminalManager terminalManager) {
    PlatformFileManager platformFileManager = new PlatformFileManager();
    TableFormatAdmins tableFormatAdmins = new TableFormatAdmins(catalogService);
    OptimizingAdmin optimizingAdmin = AdminUtil.loadOptimizingAdmin();
    this.catalogController = new CatalogController(catalogService, platformFileManager);
    this.healthCheckController = new HealthCheckController();
    this.loginController = new LoginController(serviceConfig);
    this.optimizerController = new OptimizerController(optimizerManager, optimizingAdmin);
    ...
    this.tableController =
        new TableController(catalogService, tableFormatAdmins, optimizingAdmin, serviceConfig);
  ...
  public String getFileContent() throws IOException {
    if ("".equals(indexHtml)) {
      try (InputStream fileName =
          AmoroAdminService.class.getClassLoader().getResourceAsStream("static/index.html")) {
