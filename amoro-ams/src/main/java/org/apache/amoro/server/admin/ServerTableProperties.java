...
public class ServerTableProperties {
  ...
  static {
    ...
    // TODO
    /*    HIDDEN_EXPOSED.add(IcebergTableProps.WRITE_DISTRIBUTION_MODE_NONE);
    HIDDEN_EXPOSED.add(IcebergTableProps.WRITE_DISTRIBUTION_MODE_HASH);
    HIDDEN_EXPOSED.add(IcebergTableProps.WRITE_DISTRIBUTION_MODE_RANGE);*/
